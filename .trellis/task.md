...
| commands-restructure | src-tauri commands 按域合理分包 | — | 已完成 | — | 07-09-mitm-tables-to-setting, 07-10-protocols-rust-enum |
...
| cmd-config | C5 commands-config crate | — | 已完成 | — | 07-10-core-extract |
| cmd-system | C6 commands-system crate | — | 已完成 | — | 07-10-core-extract |
| cmd-ai-tools | C7 commands-ai-tools crate | — | 已完成 | — | 07-10-core-extract |
| cmd-tray | C8 commands-tray crate（含 popover 域重划） | — | 已完成 | — | 07-10-core-extract |
| cmd-cli-env | C9 commands-cli-env crate | — | 已完成 | — | 07-10-core-extract |
| app-wiring | C10 app crate wiring + Tauri 验证 | — | 已完成 | — | 07-10-cmd-platform, 07-10-cmd-proxy, 07-10-cmd-config, 07-10-cmd-system, 07-10-cmd-ai-tools, 07-10-cmd-tray, 07-10-cmd-cli-env |
...
flowchart TD
  ...
  07-11-opencode-preset-models --> glm-coding-responses-peak-models
```
