...
| --- | --- | --- | --- | --- |
| 06-20-test-coverage-80 | 单测覆盖率≥80% | 真实覆盖面全补: vitest 全量统计 + Rust 3 缺口分支 + 前端 39 test (pages/settings/platforms) | 规划中 (prd 就绪, 排队) | — |
...
| 07-01-07-01-sensenova-platform | 商汤 SenseNova 平台支持 | 加商汤日日新平台 (Protocol/adapter/preset/粘贴识别/quota token plan) | 规划中 (research 跑中) | — |
...
| 07-01-sensenova-platform | 商汤 SenseNova 日日新平台支持 | — | 规划中 | — |
