...
| 06-30-export-ux-i18n | 导出 UX + i18n | 去「预览导出项」按钮改 debounce 自动展开 + 条目级展示 + setting label 本地化 (app:theme→主题) | 实施中 | /Users/luoxin/persons/lyxamour/aidog/.worktrees/06-30-export-ux-i18n |
...
| --- | --- | --- |
| _(无活跃 worktree)_ | — | — |
| /Users/luoxin/persons/lyxamour/aidog/.worktrees/06-30-export-ux-i18n | 06-30-export-ux-i18n | trellisx-start |
