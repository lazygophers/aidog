...
| mw-inbound-execution | 中间件 C2 入站规则执行 (过滤器/敏感词/脱敏/内容过滤/动态注入) | — | in_progress | check | 70 | — |
...
| subagent-statusline-dynamic | SubagentStatusLine 首段动态化 (type·status·model 驱动, 替代固定 [Agent·●]) | — | in_progress | exec | 10 | — |
