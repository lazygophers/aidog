...
9. 验证：`python3 -c "import json;d=json.load(open('src-tauri/defaults/platform-presets.json'));c=d['protocols']['cubence'];print(len(c['model_list']['default']),list(c['models']['default'].keys()),c['desc']['en-US'][:50])"`
