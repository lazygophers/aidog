---
title: dirty-float-hour-normalization
name: dirty-float-hour-normalization
description: 脏数据入库时归一 — 浮点 hour 拆分为整数 hour+minute
layer: recall
keywords: [Number.isInteger,浮点,hour,minute,splitFraction]
created: 1785516136
inclusion: auto
---
