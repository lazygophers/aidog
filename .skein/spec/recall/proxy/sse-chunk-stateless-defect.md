---
title: sse-chunk-stateless-defect
layer: recall
category: proxy
keywords: [SSE,streaming,stateless,chunk,frame-boundary,protocol]
status: active
inclusion: auto
created: 1722434400
---
...
[[stream-buf-unified-cap]] （上界单一真值源） · [[hot-path-buffers]] （mpsc 队列背压与缓冲） · [[async-log-queue-backpressure]] （异步日志队列）
