...
pub(crate) async fn query_zhipu_coding_plan(db: Option<&Arc<Db>>, base_url: &str, api_key: &str) -> PlatformQuota {
...
pub(crate) async fn query_minimax_coding_plan(db: Option<&Arc<Db>>, api_key: &str, is_cn: bool) -> PlatformQuota {
