...
crate::tauri_command! {
pub async fn model_entry_list(db: State<'_, Db>, platform_code: Option<String>) -> Result<Vec<gateway::models::ModelEntry>, String> {
...
crate::tauri_command! {
pub async fn model_entry_get(db: State<'_, Db>, platform_code: String, model_id: String) -> Result<Option<gateway::models::ModelEntry>, String> {
...
crate::tauri_command! {
pub async fn model_info_snapshot(db: State<'_, Db>) -> Result<gateway::models::ModelInfoSnapshot, String> {
