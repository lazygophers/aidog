...
```
src/                    # React 前端
  pages/                # 页面组件 18 个（About/AppSettings/CodexSettings/Groups/Home/Logs/Mcp/ModelTestPanel/Notifications/Platforms/PopoverConfigTab/PricingTab/Settings/SkillDetailView/SkillInstallView/Skills/Stats/TrayConfigTab）— Settings 为编排容器，子组件见 components/settings/
  components/
