...
`简体中文` · [English](README.en.md) · [Français](README.fr.md) · [Русский](README.ru.md) · [العربية](README.ar.md) · [Español](README.es.md)
...
- **国际化与主题** — 7 种语言（含阿拉伯语 RTL），Liquid Glass 等多主题 + 亮暗双模式
