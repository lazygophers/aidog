...
function App() {
  ...
  const { locale, setLocale, themeMode, toggleMode } = useApp();
  ...
  return (
    <div className="flex flex-col items-center gap-md" style={{ padding: 32, height: "100%" }}>
      {/* Header bar */}
              ...
              {ALL_LOCALES.map((loc) => (
                <button
                  ...
                  style={{
                    ...
                    background: loc === locale ? "var(--accent-subtle)" : undefined,
