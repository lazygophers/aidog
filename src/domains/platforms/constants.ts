...
export type ProtocolOption = { value: Protocol; label: string; codingPlan?: boolean; keywords?: string[]; searchTerms?: string[]; hosts?: string[]; keyPrefixes?: string[]; pasteFallback?: boolean };
