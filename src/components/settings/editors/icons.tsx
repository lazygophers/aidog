...
export const ICON_PATHS: Record<string, string> = {
  ...
  mcp: "M4 17V7a3 3 0 0 1 5.12-2.12L12 7.76l2.88-2.88A3 3 0 0 1 20 7v10 M8 17v-6l4 4 4-4v6",
  remote: "M12 20h.01 M8.5 16.4a5 5 0 0 1 7 0 M5 12.9a10 10 0 0 1 14 0 M1.5 9.4a15 15 0 0 1 21 0",
