...
[简体中文](README.md) · [English](README.en.md) · [Français](README.fr.md) · [Русский](README.ru.md) · `العربية` · [Español](README.es.md)
...
- **التدويل والسمات** — 7 لغات (بما فيها العربية RTL)، Liquid Glass وسمات أخرى بأوضاع فاتح/داكن
